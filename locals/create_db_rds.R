...
dt_database_mc[company_id %in% exp_select_AddCompany]$historical_data = 'View Data'
...
dt_database_mc[company_id %in% exp_select_AddCompany]$financial_data = 'View Data'
